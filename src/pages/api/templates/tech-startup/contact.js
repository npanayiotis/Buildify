...
export default async function handler(req, res) {
  try {
    // For contact form submission, we don't require authentication
    if (req.method === 'POST') {
      ...
      return await contactAPI.submitContactForm(req, res);
    }
    ...
    switch (req.method) {
      case 'GET':
        return await contactAPI.getContactForms(req, res);
      default:
